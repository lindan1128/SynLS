"""
Preprocess D3 dataset (Wanger_1 et al. - INRAE Herbipole, Oct 2018 - Apr 2019)
High-resolution hourly data from 28 Holstein-Friesian cows.
Data directory: demo2
...
def main():
    parser = argparse.ArgumentParser(description='Preprocess D3 dataset (Wanger_1 et al.)')
    parser.add_argument('--input', type=str,
                        default='/Users/lindan/Dropbox/PhD/Projects/PLF/GAN/Data/demo2/dataset1.tab',
                        help='Path to raw dataset')
    parser.add_argument('--output_dir', type=str,
                        default='/Users/lindan/Dropbox/PhD/Projects/PLF/GAN/Data/demo2',
